...
export type BaseInputType = "text" | "datetime-local" | "date" | "time" | "week" | "month" | "number" | "range" |
    "search" | "file" | "radio" | "checkbox" | "password" | "submit" | "tel" | "email" | "url" | "color" | "autocomplete";
